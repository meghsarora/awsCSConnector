...
(function(){
    var SERVICE_NAME = "analysisSchemeDetail";
    var SERVLET_URL =  "/bin/aws/awsanalysisschemeservlet.servlet";

    // A multi purpose http service
    var SchemeDetail = function(url){
     ...
     */
    SchemeDetail.prototype._addSelector = function(url, selector){
     ...
     * @returns {jQuery.Ajax}
     */
    SchemeDetail.prototype._send = function(method, id, data, additionalSettings){
        var settings = {
            method: method,
     ...
     */
    SchemeDetail.prototype.progress = function(inprogressFunction){
     ...
     */
    SchemeDetail.prototype.complete = function(completeFunction){
     ...
     */
    SchemeDetail.prototype.get = function(id, data, additionalSettings){
     ...
     * @param {*} additionalSettings additional settings for jQuery ajax request
     */
    SchemeDetail.prototype.create = function(id, data, additionalSettings){
     ...
     * @param {*} additionalSettings additional settings for jQuery ajax request
     */
    SchemeDetail.prototype.update = function(id, data, additionalSettings){
    ...
    SchemeDetail.prototype['delete'] = function(id, additionalSettings){
        return this._send("DELETE", id, null, additionalSettings);
    };

    // register the http service
    window.awsCSConnector.registry.register(SERVICE_NAME, new SchemeDetail(SERVLET_URL));
